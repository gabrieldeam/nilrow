...
public class SwaggerConfig {
    ...
    public GroupedOpenApi v1Api() {
        return GroupedOpenApi.builder()
                .group("v1")
                .pathsToMatch("/auth/**", "/user/**", "/people/**", "/products/**", "/brands/**", "/product-templates/**", "/address/**", "/channels/**", "/follows/**", "/chats/**", "/about/**", "/faqs/**", "/catalog/**", "/locations/**", "/categories/**", "/subcategory/**", "/user-category-order/**")
                .build();
    }
