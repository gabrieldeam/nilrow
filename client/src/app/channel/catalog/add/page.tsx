...
import React, { useCallback, useState, memo, useEffect, useMemo, ChangeEvent } from 'react';
  ...
  const handleSubmit = useCallback(
    async (e: React.FormEvent<HTMLFormElement>) => {
      ...
      if (validateForm()) {
        ...
        const catalogData: CatalogDTO & { operatingHoursType: string; operatingHours: any } = {
          ...formData,
          operatingHoursType,
          operatingHours,
        };
        ...
        try {
          ...
          if (error.response && error.response.data) {
            const errorMessage =
              error.response.data.message || 'Erro ao criar o catálogo. Tente novamente.';
